...
// Шапка дашборда — картинка статична (суммы нарисованы прямо на ней), но с
// 07.09.2026 они больше не декоративные: 60 000 / 100 000 / 150 000 — это
// реальные пороги уровней CommissionTier (Минимум/Базовый/Развитие), которые
// определяют % от своей комиссии в зарплате (см. блок «План» ниже). Если
// пороги в Django admin поменяют, эту картинку тоже придётся перерисовать —
// текст на ней не читается из API.
